...
<template>
  <h1>NNM Vue Component Library</h1>

  <p>
    Welcome to this playground for coming up with ideas of nice-to-have and
    easy-to-work-with components and convenience tools created with Vue. The
